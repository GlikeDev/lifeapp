...
const dr = StyleSheet.create({
  ...
  note:      { fontSize: Typography.sizeXS, color: Colors.textSecondary, marginTop: 2 },
  date:      { fontSize: Typography.sizeXS, color: Colors.textMuted, marginTop: 2 },
  right:     { alignItems: 'flex-end', gap: Spacing.xs },
  amount:    { fontSize: Typography.sizeMD, fontWeight: Typography.weightBold },
  ...
  settleTxt: { fontSize: Typography.sizeXS, fontWeight: Typography.weightSemiBold },
});
...
const s = StyleSheet.create({
  ...
  heroAmount:{ fontSize: 36, fontWeight: Typography.weightBold },
  heroSub:   { fontSize: Typography.sizeXS, color: Colors.textMuted, marginTop: 4 },
  ...
  heroStatLabel:{ fontSize: Typography.sizeXS, color: Colors.textSecondary, marginBottom: 4 },
  heroStatAmt:  { fontSize: Typography.sizeLG, fontWeight: Typography.weightBold },
  heroStatCount:{ fontSize: Typography.sizeXS, color: Colors.textMuted, marginTop: 2 },
